                            ...
                            syn::FnArg::Typed(t) => match &*t.ty {
                                syn::Type::Path(p) => {
                                    for seg in &p.path.segments {
                                        if seg.ident == "Vec3" {
                                            arg_types.push(seg.ident.clone());
                                        } else {
                                ...
                                syn::Type::BareFn(_) => eprintln!("BareF"),
                                syn::Type::Group(_) => eprintln!("Group"),
                                syn::Type::ImplTrait(_) => eprintln!("ImplT"),
                                syn::Type::Infer(_) => eprintln!("Infer"),
                                syn::Type::Macro(_) => eprintln!("Macro"),
                                syn::Type::Never(_) => eprintln!("Never"),
                                syn::Type::Paren(_) => eprintln!("Paren"),
                                ...
                                syn::Type::Tuple(_) => eprintln!("Tuple"),
                                syn::Type::Verbatim(_) => eprintln!("Verba"),
                                syn::Type::__TestExhaustive(_) => eprintln!("__Tes"),
                            },
                            _ => (),
                        }
                    }
